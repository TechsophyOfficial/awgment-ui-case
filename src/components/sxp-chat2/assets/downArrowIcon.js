...
const DownArrowIcon = () => (
  <div className="sc-user-input--picker-wrapper">
    ...
    {/* // > */}
      ...
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#2c98f0" width="18px" height="18px"><path d="M0 0h24v24H0z" fill="none"/><path d="M7 10l5 5 5-5z"/></svg>    {/* </button> */}
  </div>
);
